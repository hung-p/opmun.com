          ...
          <div className="space-y-24">
            ...
            >
              <div className="md:w-5/12 ml-10 md:ml-0 md:text-right">
                <span className="font-label text-primary text-xl font-bold block mb-2 drop-shadow-[0_0_10px_rgba(0,229,255,0.5)]">Q1 2029</span>
              ...
              <div className="absolute left-[20px] md:left-1/2 -translate-x-1/2 w-10 h-10 bg-primary rounded-full flex items-center justify-center border-4 border-background z-10 shadow-[0_0_20px_rgba(0,229,255,0.6)] group-hover:scale-110 transition-transform duration-500">
            ...
            >
              <div className="hidden md:block md:w-5/12"></div>
              <div className="absolute left-[20px] md:left-1/2 -translate-x-1/2 w-10 h-10 bg-surface-container-high border-2 border-outline rounded-full flex items-center justify-center z-10 group-hover:border-primary group-hover:shadow-[0_0_15px_rgba(0,229,255,0.3)] transition-all duration-500">
                <Database className="text-outline w-5 h-5 group-hover:text-primary transition-colors" />
              </div>
              <div className="md:w-5/12 ml-10 md:ml-0">
                <span className="font-label text-outline text-xl font-bold block mb-2 group-hover:text-primary/80 transition-colors">Q3 2029</span>
            ...
            >
              <div className="md:w-5/12 ml-10 md:ml-0 md:text-right">
                <span className="font-label text-outline text-xl font-bold block mb-2 group-hover:text-primary/80 transition-colors">2029</span>
